...
let pesoConsola;
let fotoConsola;
let rayita=document.getElementById("rayita");
let rayita2=document.getElementById("rayita2");

rayita.classList.add("invisible");
rayita2.classList.add("invisible");
...
function capturarDatos(){
    ...
    rayita.classList.remove("invisible");
    rayita2.classList.remove("invisible");
    rayita.classList.add("visible");
    rayita2.classList.add("visible");
...
function limpiarCarrito(){
    ...
    let tituloCarrito=document.getElementById("tituloCarrito");
    tituloCarrito.textContent=("Tu carrito esta vacio");
    ...
    rayita.classList.remove("visible");
    rayita2.classList.remove("visible");
    rayita.classList.add("invisible");
    rayita2.classList.add("invisible");
